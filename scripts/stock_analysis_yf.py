...
# -*- coding: utf-8 -*-
"""
5-10倍潜力股分析脚本 - 使用Yahoo Finance获取数据
带历史推荐存储功能
"""
...
def run_new_analysis():
    """运行新的分析并保存结果"""
    print("=" * 60)
    print("股票分析 - 5-10倍潜力股筛选 (Yahoo Finance + History)")
    print("=" * 60)
    print()
    ...
    print()
    print("📋 查看历史推荐用法:")
    print("  python stock_analysis_yf.py --history                 # 查看全部历史(最新在前)")
    print("  python stock_analysis_yf.py --history --ticker NVDA   # 查看NVDA历史推荐")
    print("  python stock_analysis_yf.py --history --sector AI      # 查看AI板块历史")
    print("  python stock_analysis_yf.py --history --date 2026-04   # 查看2026年4月历史")
    print("  python stock_analysis_yf.py --history --limit 10       # 只看最新10条")

def main():
    parser = argparse.ArgumentParser(description='股票分析工具 - Yahoo Finance + 历史推荐记录')
